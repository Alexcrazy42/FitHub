...
Отдельные срезы:
- [BankManager: оплата резервации перед созданием заказа](./bankManager.md)
- [Marketplace Delivery: доставка и live-трекинг как в Яндекс Доставке](./delivery.md)
...
- [x] Физические товары
- [x] Один склад
- [x] BankManager: отдельный процесс
- [x] Симуляция курьеров: интерполяция
- [x] Хранение адресов: строка в delivery read model на MVP, нормализованная структура позже при необходимости

Решения зафиксированы в [Decisions.md](./Decisions.md).
